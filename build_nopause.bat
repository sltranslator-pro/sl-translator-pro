...
cl.exe /EHsc /O2 /MT /DNDEBUG /I"minhook\include" /LD /Fe:dinput8.dll version.cpp hook.obj buffer.obj trampoline.obj hde64.obj /link /DLL user32.lib winhttp.lib shell32.lib kernel32.lib gdi32.lib ws2_32.lib
if errorlevel 1 goto fail
